<div class="tab-pane fade" id="vl-pills-featured_image" role="tabpanel" aria-labelledby="vl-pills-featured_image-tab">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title">{{ trans('blog::blog.posts.groups.featured_image') }}</h4>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
