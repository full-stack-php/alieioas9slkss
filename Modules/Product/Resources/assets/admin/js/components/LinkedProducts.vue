...
const upSellProducts = ref(Korf.data["up-sell-products"] ?? []);
const upSellProductsField = ref(null);
const crossSellProducts = ref(Korf.data["cross-sell-products"]);
const crossSellProductsField = ref(null);
const relatedProducts = ref(Korf.data["related-products"]);
