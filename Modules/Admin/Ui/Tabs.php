...
abstract class Tabs
{
    ...
    /**
     * Рендерит контент (вьюхи табов) только для указанной группы.
     *
     * @param string $group
     * @param array $data
     * @return HtmlString
     */
    public function renderGroupContent($extraData = [])
    {
        return new HtmlString($this->getTabsData('view', $this->data));
    }
