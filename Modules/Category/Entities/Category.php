...
{
    use Translatable, Sluggable, HasMetaData, HasMedia, NestableTrait, HasFaq;
     ...
     * @var array
     */
    protected $fillable = ['parent_id', 'slug', 'position', 'is_active', 'is_searchable', 'old_id'];
     ...
     * @var array
     */
    protected $translatedAttributes = ['name', 'h1_name', 'description'];
    ...
    public function exportFields(): array
    {
        return [
            ...
            'description' => 'Описание (Перевод)',
            'slug' => 'ЧПУ (URL)',
            'is_active' => 'Статус (Активна)',
            'image' => 'Изображение',
            // добавьте сюда другие поля из вашей таблицы categories
        ];
    }
