...
use Modules\Core\Http\Middleware\CheckQueryParamsForRobots;
use Modules\Core\Http\Middleware\ResolveEntityFromUrl;
...
class RouteServiceProvider extends ServiceProvider
{
    ...
    {
        // Removed 'locale_session_redirect',
        Route::group([
            'namespace' => $namespace,
            'prefix' => LaravelLocalization::setLocale(),
            'middleware' => ['localize', 'localization_redirect', 'web', ResolveEntityFromUrl::class, CheckQueryParamsForRobots::class],
