...
@push('meta')
    ...
    <meta name="description" content="{{ $category->meta->meta_description }}">
    <meta name="twitter:card" content="summary">
    <meta property="og:url" content="{{ url()->current() }}">
    <meta property="og:title" content="{{ $category->meta->meta_title ?: $category->name }}">
    <meta property="og:description" content="{{ $category->meta->meta_description }}">
...
@section('content')
    ...
    <main>
        <div class="container">
            ...
            @if(strlen($category->description) > 7)
                <div class="row mt-5">
