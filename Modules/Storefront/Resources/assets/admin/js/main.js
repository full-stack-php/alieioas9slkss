...
$("#storefront_theme_color").on("change", (e) => {
    if (e.currentTarget.value === "custom_color") {
        $("#custom-theme-color").removeClass("d-none");
    } else {
        $("#custom-theme-color").addClass("d-none");
    }
});

$("#storefront_mail_theme_color").on("change", (e) => {
    if (e.currentTarget.value === "custom_color") {
        $("#custom-mail-theme-color").removeClass("d-none");
    } else {
        $("#custom-mail-theme-color").addClass("d-none");
    }
});
...
$("#storefront-settings-edit-form").on("click", ".panel-image", (e) => {
    ...
    picker.on("select", (file) => {
        ...
        target.find("img").attr("src", file.path).removeClass("d-none");
...
$("#storefront-settings-edit-form").on("click", ".remove-image", (e) => {
    ...
    target.parent().find("img").removeAttr("src").addClass("d-none");
...
$(".product-type").on("change", (e) => {
    ...
    categoryProducts.addClass("d-none");
    productsLimit.addClass("d-none");
    customProducts.addClass("d-none");
    ...
    if (
        ...
        productsLimit.removeClass("d-none");
    }

    if (e.currentTarget.value === "custom_products") {
        customProducts.removeClass("d-none");
    }
});
