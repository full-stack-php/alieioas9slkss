...
class Banner
{
    ...
    public function __construct($image, $title, $subtitle, $call_to_action_url, $open_in_new_window)
    {
        $this->image = $image;
        $this->title = $title;
    ...
    public static function getThreeColumnFullWidthBanners()
    {
        return [
            ...
            'banner_4' => self::findByName('storefront_three_column_full_width_banners_4'),
        ];
    }
    ...
    public static function getFourColumnBanners()
    {
        return [
            ...
            'banner_4' => self::findByName('storefront_three_column_banners_4'),
        ];
    }
