...
@component('admin::components.page.header')
    ...
    <li class="breadcrumb-item"><a href="{{ route('admin.reviews.index') }}">{{ trans('review::reviews.reviews') }}</a></li>
    <li class="breadcrumb-item active">{{ trans('admin::resource.edit', ['resource' => trans('review::reviews.review')]) }}</li>
@endcomponent
