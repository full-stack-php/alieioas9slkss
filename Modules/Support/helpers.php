...
if (!function_exists('korf_version')) {
    /**
     * Get the korf version.
     *
     * @return string
     */
    function korf_version()
    {
        return '1.0.0';
    }
}
...
if (!function_exists('is_core_module')) {
    ...
    {
        return in_array(strtolower($module), config('korf.modules.core.config.core_modules'));
    }
}
